...
:git:`~doc/tutorialsexercises/electronic/dos/top.py`

PDOS script (:git:`~doc/tutorialsexercises/electronic/dos/pdos.py`):
...
Pickle script (:git:`~doc/tutorialsexercises/electronic/dos/p1.py`):

.. literalinclude:: p1.py

Plot PDOS (:git:`~doc/tutorialsexercises/electronic/dos/p2.py`):
...
LCAO PDOS (see :git:`~doc/tutorialsexercises/electronic/dos/lcaodos_gs.py` and
:git:`~doc/tutorialsexercises/electronic/dos/lcaodos_plt.py`):
...
Last part of :git:`~doc/tutorialsexercises/electronic/dos/lcaodos_plt.py` script:
